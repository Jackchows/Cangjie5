...
根據沈紅蓮女士的[回信（一）](http://ejsoon.win/phpbb/viewtopic.php?f=3&t=789)，「軣」取「十十金金」，其它包含相同部件的字一併修改：䏮塁摂渋疂𫝓𮐪𮓼𮛎
...
14. 包含倒轉部件漢字的取碼<br />
「𠄏」、「𰒥」「𫸪」、「𣥒」、「𠄔」、「𨙨」、「𢨋」、「𧹂」、「𮗙」等字，分別包含「了」、「弓」、「戈」、「止」、「予」、「邑」、「或」、「虎」、「鬼」旋轉或翻轉產生的部件。這些部件不常用，取碼較困難。<br />
六代「片」鍵增設一功能表示「翻轉」，如「𠄏」字取碼「弓弓片」（先按「了」取碼「弓弓」，然後補一「片」表示旋轉）。<br />
本碼表採用此方法，用於倒「了」、倒「弓」、倒「戈」、倒「止」、倒「予」、倒「邑」、倒「虎」、倒「或」和倒「鬼」。如：
...
|23028|𣀨|戈片.卜水|戈口.卜水|
|2E5D9|𮗙|月山.竹山片|月山.中弓竹|
|304A5|𰒥|戈片.戈|戈戈.戈|
|30C9E|𰲞|戈山.戈片/戈弓.戈片|戈山.戈大戈/戈弓.戈大戈|

為免困擾，暫設定此方法適用範圍限於倒「了」、倒「弓」、倒「戈」、倒「止」、倒「予」、倒「邑」、倒「虎」、倒「或」和倒「鬼」。<br />
同時保留不使用「片」的取碼作為容錯碼。

...
14. 包含倒轉部件漢字的取碼<br />
「𠄏」、「𫸪」、「𣥒」、「𠄔」、「𨙨」、「𢨋」、「𧹂」、「𮗙」等字，分別包含「了」、「弓」、「止」、「予」、「邑」、「或」、「虎」、「鬼」旋轉或翻轉產生的部件。這些部件不常用，取碼較困難。<br />
六代「片」鍵增設一功能表示「翻轉」，如「𠄏」字取碼「弓弓片」（先按「了」取碼「弓弓」，然後補一「片」表示旋轉）。<br />
本碼表採用此方法，用於倒「了」、倒「弓」、倒「止」、倒「予」、倒「邑」、倒「虎」、倒「或」和倒「鬼」。如：
...
為免困擾，暫設定此方法適用範圍限於倒「了」、倒「弓」、倒「止」、倒「予」、倒「邑」、倒「或」、倒「虎」和倒「鬼」。<br />
同時保留不使用「片」的取碼。

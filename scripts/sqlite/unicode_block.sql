...
INSERT INTO "unicode_block" ("name", "name_abbr", "start_hex", "end_hex", "start_dec", "end_dec", "area_no") VALUES
	...
	('CJK Unified Ideographs Extension C', 'UC', '0x2a700', '0x2b73f', 173824, 177983, 4),
	('CJK Unified Ideographs Extension D', 'UD', '0x2b740', '0x2b81d', 177984, 178205, 5),
	('CJK Unified Ideographs Extension E', 'UE', '0x2b820', '0x2cead', 178208, 183981, 6),
	...
	('CJK Unified Ideographs Extension J', 'UJ', '0x323b0', '0x33479', 205744, 210041, 11),
	('CJK Compatibility Ideographs', 'CI', '0xf900', '0xfaff', 63744, 64255, 20),
	('CJK Compatibility Ideographs Supplement', 'CIS', '0x2f800', '0x2fa1f', 194560, 195103, 21),
	('Kangxi Radicals', 'KR', '0x2f00', '0x2fdf', 12032, 12255, 22),
	('CJK Radicals Supplement', 'RS', '0x2e80', '0x2eff', 11904, 12031, 23),
	('CJK Strokes', 'S', '0x31c0', '0x31e5', 12736, 12773, 24),
	('CJK Symbols and Punctuation', 'SP', '0x3000', '0x303f', 12288, 12351, 25),
	('CJK Compatibility Forms', 'CF', '0xfe30', '0xfe4f', 65072, 65103, 26),
	('Bopomofo', 'B', '0x3100', '0x312f', 12544, 12591, 27),
	('Ideographic Description Character', 'IDC', '0x2ff0', '0x2fff', 12272, 12287, 28),
	('Counting Rod Numerals', 'CRN', '0x1d360', '0x1d37f', 119648, 119679, 29),
